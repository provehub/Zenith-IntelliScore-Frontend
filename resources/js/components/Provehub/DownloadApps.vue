<template>
    ...
    <div class="relative isolate bg-white dark:bg-white">
          ...
          <div class="mx-auto max-w-7xl px-6 py-14 sm:py-22 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-30">
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div class="flex">
                <div class="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  <span class="font-semibold text-blue-600">Beyond the Website</span>
              ...
              <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">A better way to Zenith IntelliScore</h1>
              <p class="mt-6 text-lg leading-8 text-gray-600">Download the app on Google Playstore and Apple Store.</p>
              <div class="mt-10 flex items-center gap-x-6">

                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                  <img :src="$page.props.site.img_share.googleplay" class="h-12 pr-12 transform hover:scale-125 duration-300 ease-in-out" />
                  <img :src="$page.props.site.img_share.applestore" class="h-12 transform hover:scale-125 duration-300 ease-in-out" />
                </div>
            ...
            <div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
              <svg viewBox="0 0 366 729" role="img" class="mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
                ...
                <foreignObject width="316" height="684" transform="translate(24 24)" clip-path="url(#2ade4387-9c63-4fc4-b754-10e687a0d332)">
                  <img :src="$page.props.site.img_share.m" alt="" />
                </foreignObject>
              </svg>
            </div>
          </div>
