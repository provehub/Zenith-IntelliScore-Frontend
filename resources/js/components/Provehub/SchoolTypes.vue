  ...
  <div class="xl:container m-auto px-6 text-gray-500 md:px-12">
    <div>
      <h2 class="mt-4 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
        The Awaken Economic Community (AEC)  <br class="lg:block" hidden /> The AEC is an initiative predicated on the following facts:
      </h2>
    </div>
    <div
    ...
    >
        ...
        <div class="relative space-y-8 py-12 p-8">
          ...
          <div class="space-y-2">
            <p class="text-sm text-gray-600 dark:text-gray-300">
              The Zenith IntelliScore believes that We, the People, are our Nation's most valuable asset.
            </p>
          </div>
      ...
      <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div class="relative space-y-8 py-12 p-8">
          ...
          <div class="space-y-2">
            <p class="text-sm text-gray-600 dark:text-gray-300">
              Evidence of our tenacious and entrepreneurial spirit is found in the resounding success of the indigenous and independently born Nollywood and Afrobeats, multi billion dollar industries that Government had no hand in developing.
            </p>
          </div>
      ...
      <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div class="relative space-y-8 py-12 p-8">
          ...
          <div class="space-y-2">
            <p class="text-sm text-gray-600 dark:text-gray-300">
              As such, the AEC aims to provide a variety of businesses that our memers can plug into to earn an alternative income.
            </p>
          </div>
