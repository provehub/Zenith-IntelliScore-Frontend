...
<div class="">
        <div class="">
          <!-- absolute -->
            <div class=" ">
               <!-- absolute -->
                <div class="bg-white shadow-md rounded-lg px-1 py-1">
                    <div class="flex items-center rounded-md">
                        <div class="w-full sm:w-80 md:max-w-sm lg:w-[30rem] flex items-center rounded-lg overflow-hidden">
                    ...
                    <div class="text-sm overflow-y-scroll h-[200px] z-20" >
                        <div class="flex justify-start text-gray-700 hover:text-blue-400 hover:bg-blue-100 rounded-md px-2 py-2 " v-for="result in results" :key="result.id">
                            ...
                            <div class="flex font-medium px-2">
                              <div class="h-10 w-10 flex-none items-center justify-center rounded-lg">
                      <img :src="result.images[0].img" class="h-6 w-6" />
                    </div>
